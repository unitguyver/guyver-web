...
import TextHighlightRules from "./highlight";
import CstyleBehaviour from "../../lib/behaviour/cstyle";
import lang from "../../../lib/utils/lang";
import unicode from "../../../lib/utils/unicode";

export default class TextMode {
    $id = "ace/mode/text";
    HighlightRules = TextHighlightRules;
    $defaultBehaviour = new CstyleBehaviour();
    tokenRe = new RegExp("^[" + unicode.wordChars + "\\$_]+", "g");
    nonTokenRe = new RegExp("^(?:[^" + unicode.wordChars + "\\$_]|\\s])+", "g");
