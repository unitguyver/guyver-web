...
export default class HtmlCompletions {
    ...
    getTagCompletions = function (state, session, pos, prefix) {
    ...
    getAttributeCompletions = function (state, session, pos, prefix) {
    ...
    getAttributeValueCompletions = function (state, session, pos, prefix) {
        var tagName = findTagName(session, pos);
    ...
    getHTMLEntityCompletions = function (state, session, pos, prefix) {
