...
import DefaultHandlers from "./default_handlers";
import DefaultGutterHandler from "./default_gutter_handler";
import MouseEvent from "./mouse_event";
import DragdropHandler from "./dragdrop_handler";
import addTouchListeners from "./touch_handler";

const MouseHandler = function (editor) {
    var _self = this;
    this.editor = editor;
