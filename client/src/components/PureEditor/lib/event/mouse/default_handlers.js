...
let DRAG_OFFSET = 0; // pixels
let SCROLL_COOLDOWN_T = 550; // milliseconds

const DefaultHandlers = function (mouseHandler) {
    mouseHandler.$clickSelection = null;

    let editor = mouseHandler.editor;
    ...
    let exports = ["select", "startSelect", "selectEnd", "selectAllEnd", "selectByWordsEnd",
