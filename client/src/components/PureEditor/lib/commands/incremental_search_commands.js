...
const { occurStartCommand } = require("./occur_commands");
...
export const iSearchStartCommands = [
    {
        ...
        exec: function (editor, options) {
            config.loadModule(["core", "incremental_search"], function (e) {
...
const IncrementalSearchKeyboardHandler = function (iSearch) {
...
export { IncrementalSearchKeyboardHandler };