...
import UA from "../lib/utils/useragent";

const getCSSProperty = function (element, container, property) {
...
ace.transformTextarea = function (element, options) {
    ...
    options = options || ace.defaultOptions;
...
function setupSettingPanel(settingDiv, settingOpener, editor) {
    ...
    for (var option in ace.defaultOptions) {
