...
import LineWidgets from "../editor/tools/LineWidgets";
...
export const setLenses = function (session, lenses) {
...
export const registerCodeLensProvider = function (editor, codeLensProvider) {
    editor.setOption("enableCodeLens", true);
    editor.codeLensProviders.push(codeLensProvider);
    editor.$updateLensesOnInput();
};

export const clear = function (session) {
