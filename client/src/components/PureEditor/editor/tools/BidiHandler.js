...
import bidiUtil from "../../lib/utils/bidiutil";

const bidiRE = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\u202B]/;

export default class BidiHandler {
    bidiMap = {};
    currentRow = null;
    bidiUtil = bidiUtil;
    charWidths = [];
    ...
    isBidiRow = function (screenRow, docRow, splitIndex) {
        if (!this.seenBidi)
            return false;
    ...
    updateRowLine = function (docRow, splitIndex) {
        if (docRow === undefined)
    ...
    updateCharacterWidths = function (fontMetrics) {
    ...
    setRtlDirection = function (editor, isRtlDir) {
