...
export default class Gutter {
    ...
    $updateGutterWidth = function (config) {
        var session = this.session;
    ...
    $renderLines = function (config, firstRow, lastRow) {
        var fragment = [];
        var row = firstRow;
    ...
    $renderCell = function (cell, config, fold, row) {
    ...
    setHighlightGutterLine = function (highlightGutterLine) {
        this.$highlightGutterLine = highlightGutterLine;
    };

    setShowLineNumbers = function (show) {
        this.$renderer = !show && {
